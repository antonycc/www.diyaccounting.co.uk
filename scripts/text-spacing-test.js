 ...
 *   --output FILE  Output JSON file (default: web/www.diyaccounting.co.uk/public/tests/accessibility/text-spacing-results.json)
 */
...
const outputFile = getArg("--output", "web/www.diyaccounting.co.uk/public/tests/accessibility/text-spacing-results.json");
