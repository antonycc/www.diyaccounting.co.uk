...
| CloudFront dist | `E6YTNLAL2VBNN` / `de9dto3k3vhcf.cloudfront.net` | ci-gateway.diyaccounting.co.uk |
| CloudFront dist | `E3U3O7ZH7B8234` / `dnloza7zl3wfi.cloudfront.net` | www.diyaccounting.co.uk, prod-gateway.diyaccounting.co.uk, diyaccounting.co.uk |
...
| ACM certificate | `arn:aws:acm:us-east-1:283165661847:certificate/18008e08-0475-4ba0-8516-834fd5f447d9` | TLS for CloudFront (ci-gateway.diyaccounting.co.uk) |
